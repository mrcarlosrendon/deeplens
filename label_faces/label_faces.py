    ...
    try:
        ...
        while doInfer:
            ...
            for obj in parsed_results:
                ...
                bounds = {"Left": xmin, "Top": ymin, "Width": xmax - xmin, "Height": ymax-ymin}
                face_name = describe_image.identify_face(frame, bounds)
                client.publish(topic=iotTopic, payload="Detected: " + face_name)
                describe_image.label_face(frame, bounds, face_name)
